...
seed_target = [ "right-left" "left-right"]; %"left-left" "right-right"

for ii = 1:5
    for kk = 1:2
        helper_automaticSave_effective(char(band_name(ii)), char(seed_target(kk)))
    end
end


function helper_automaticSave_effective(band_name, seed_target)
